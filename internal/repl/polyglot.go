...
var Backends = []Backend{
	...
	},
	{
		...
		Cmd:         "zsh",
		Args:        []string{"-i"},
		Env:         []string{"BOXXY_SHELL=1", "BOXXY_GF3=true"},
		Description: "Interactive zsh with boxxy color environment and GF(3) prompt",
		Trit:        -1,
		Color:       "#06B6D4",
	},
	{
		...
		Cmd:         "fish",
		Args:        []string{},
		Description: "Fish shell — structured suggestions, web-based config",
		Trit:        0,
		Color:       "#22D3EE",
	},
	{
		...
		Cmd:         "elvish",
		Args:        []string{},
		Description: "Elvish — structured shell with value pipelines",
		Trit:        -1,
		Color:       "#818CF8",
	},
	{
